...
async function runTests() {
    ...
    // Test 4: Mode auto - encrypted room
    {
        ...
        assert.strictEqual(lkOpts.encryption.encryptionType, EncryptionType.GCM);
        assert.strictEqual(lkOpts.encryption.keyProviderOptions.ratchetWindowSize, 10);
        assert.strictEqual(lkOpts.encryption.keyProviderOptions.keyRingSize, 256);
        assert.strictEqual(lkOpts.encryption.keyProviderOptions.keyDerivationFunction, 1); // HKDF
    ...
    // Test 17: connectOptions compatibility with LiveKit Room.connect and RoomOptions
    {
        ...
        assert.strictEqual(connectOptions.encryption.keyProviderOptions.keyDerivationFunction, 1); // HKDF
